/*
  ...
  gengetopt --no-handle-help --no-handle-version --no-handle-error --string-parser
...
void clear_given (struct gengetopt_args_info *args_info)
{
  ...
  args_info->conversation_group_counter = 0 ;
}
...
static void
reset_group_conversation(struct gengetopt_args_info *args_info)
{
  if (! args_info->conversation_group_counter)
    return;
                        ...
                        struct cmdline_parser_params *params, const char *additional_error)
{
        ...
        case 0:	/* Long option with no short option */
          ...
          else if (strcmp (long_options[option_index].name, "cue") == 0)
          {
            ...
            if (args_info->conversation_group_counter && override)
              reset_group_conversation (args_info);
            args_info->conversation_group_counter += 1;
  ...
  if (args_info->conversation_group_counter > 1)
    {
      fprintf (stderr, "%s: %d options of group conversation were given. At most one is required%s.\n", argv[0], args_info->conversation_group_counter, (additional_error ? additional_error : ""));
      error = 1;
    }
